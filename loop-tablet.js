...
function getNumbersTablet() {
    
    document.getElementById("userBox").innerHTML = "";
    document.getElementById("userBox2").innerHTML = "";
    
    do {
        var userInt = parseInt(prompt("Please enter any whole number between 1 and 50"));
        if (userInt < 1 || userInt > 50) {
            alert("Number entered is out of range. Please enter a number between 1 and 50 only.");
        } else {            
